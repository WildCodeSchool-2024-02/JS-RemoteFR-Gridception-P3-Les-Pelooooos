...
export default function InscriptionProfil() {
  ...
  //   e.preventDefault();
  //   try {
  //     const responseUsers = await axios.post('http://localhost:3310/api/users', users);
  //     const responseCars = await axios.post('http://localhost:3310/api/cars', cars);
  //     console.log(responseUsers.data && responseCars.data);
  //     // Gérer la réponse (ex. redirection, message de succès, etc.)
  //     setMessage('Enregistrement valider');
  //     // Rediriger l'utilisateur vers la page de login après 2 secondes
  //     setTimeout(() => {
  //       navigate('/login');
  //     }, 2000);
  //   } catch (error) {
  //     setMessage('Inscription non valide. Merci de réessayer.');
  //     console.error(error);
